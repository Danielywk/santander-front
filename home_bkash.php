...
.different-text-color { color: green; }
                      ...
                      <h1 class="page-head-line">Company Bkash Amount</h1>
                     <marquee> <h1 class="page-subhead-line"> <p style="font-size:x-large;"><span class="different-text-color">Welcome to <strong><?php echo ' '. $siteName ?></strong>@@@ Today is:
      ...
      <div class="well bs-component">
          <form class="form-horizontal">
              <fieldset>
                <button type="button" data-toggle="modal" data-target="#addbkash" class="btn btn-success">New Given Bkash Amount</button>
                  ...
                  <div class="modal-body" style="padding:40px 50px;">
                      ...
                      <form class="form-horizontal" action="add_bkash.php" name="form" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="datepicker" value="<?php echo $thisDate;?>" name="given_date" type="text" />
                                <script>
