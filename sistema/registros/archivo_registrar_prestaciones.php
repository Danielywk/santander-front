...
if (isset($_POST['id_visitante']) and isset($_POST['material']) and isset($_POST['observaciones']) 
    ...
    //redirección
      echo"<script type=\"text/javascript\">alert('Sus datos han sido enviados exitosamente...'); window.location='/servicioweb/prestaciones.php';</script>"; 

}//si no se enviaron datos
else{
    echo"<script type=\"text/javascript\">alert('Error (410) Los datos no han sido enviados...'); window.location='/servicioweb/prestaciones.php';</script>";  
}
    //redirección
