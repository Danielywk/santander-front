...
if (isset($_POST['name']) and isset($_POST['apellido']) and isset($_POST['e']) 
    ...
    //redirección
    echo"<script type=\"text/javascript\">alert('Sus datos han sido enviados exitosamente...'); window.location='/org/visitantes.php';</script>";  
    
}//si no se enviaron datos
else{
     echo"<script type=\"text/javascript\">alert('Error (410) Los datos no han sido enviados...'); window.location='/org/visitantes.php';</script>";  
}
    //redirección
